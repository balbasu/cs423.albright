...
namespace Lab02
{
    internal class Program
    {
        ...
        static int queens; // number of queens placed on board
        ...
        static void Main(string[] args)
        {
            ...
            board = new bool[ 8, 8 ]; // all element default to false
        ...
        public static void UpdateDiagonals( int rowValue, int colValue)
        {
            ...
            // upper left diagonal
            for (int diagonal = 0; diagonal < 8 && ValidMove(--row, --column); diagonal++) access[ row, column ] = maxAccess;
        ...
        public static void PrintBoard()
        {
            ...
            // display numbers for the column
            for (int k = 0; k < 8; k++) Console.Write(" {0}", k);
            ...
            for (int row = 0; row < board.GetLength(0); row++)
            {
                ...
                {
                    if (board[row, column]) Console.WriteLine(" Q");
